...
// Source: sigs.k8s.io/kueue/pkg/controller/jobframework (interfaces: GenericJob,JobWithCustomValidation,JobWithManagedBy,JobWithCustomWorkloadActivation,JobWithCustomAnnotations)
//
// Generated by this command:
//
//	mockgen -destination=internal/mocks/controller/jobframework/interface.go -copyright_file hack/boilerplate.txt -package mocks sigs.k8s.io/kueue/pkg/controller/jobframework GenericJob,JobWithCustomValidation,JobWithManagedBy,JobWithCustomWorkloadActivation,JobWithCustomAnnotations
//
...
// MockJobWithCustomAnnotations is a mock of JobWithCustomAnnotations interface.
type MockJobWithCustomAnnotations struct {
	ctrl     *gomock.Controller
	recorder *MockJobWithCustomAnnotationsMockRecorder
	isgomock struct{}
}

// MockJobWithCustomAnnotationsMockRecorder is the mock recorder for MockJobWithCustomAnnotations.
type MockJobWithCustomAnnotationsMockRecorder struct {
	mock *MockJobWithCustomAnnotations
}

// NewMockJobWithCustomAnnotations creates a new mock instance.
func NewMockJobWithCustomAnnotations(ctrl *gomock.Controller) *MockJobWithCustomAnnotations {
	mock := &MockJobWithCustomAnnotations{ctrl: ctrl}
	mock.recorder = &MockJobWithCustomAnnotationsMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockJobWithCustomAnnotations) EXPECT() *MockJobWithCustomAnnotationsMockRecorder {
	return m.recorder
}
