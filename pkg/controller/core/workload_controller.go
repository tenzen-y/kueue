...
func (r *WorkloadReconciler) podsScheduledTrackingEnabled() bool {
	return features.Enabled(features.WaitForPodsReadyUnschedulableTimeout) &&
		r.waitForPodsReady != nil && r.waitForPodsReady.unschedulableTimeout != nil && *r.waitForPodsReady.unschedulableTimeout > 0
}
...
func (r *WorkloadReconciler) schedulingDeadline(wl *kueue.Workload, admittedAt time.Time) time.Time {
	...
	schedulingDeadline := metav1.NewTime(admittedAt.Add(*r.waitForPodsReady.unschedulableTimeout))
